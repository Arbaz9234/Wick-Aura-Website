...
export default function OurPolicy() {
  return (
    <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-12 text-xs sm:text-sm md:text-base">
      <div>
        <Palette className="w-10 m-auto mb-5 h-10" color="#000000" />
        <p className="font-semibold">Wide Color Selection</p>
        <p className="text-gray-600">Match any mood or décor.</p>
      </div>
      <div>
        <Sparkles className="w-10 m-auto mb-5 h-10" color="#000000" />
        <p className="font-semibold">Personalized Crafting</p>
        <p className="text-gray-600">Custom-made just for you.</p>
      </div>
      <div>
        <svg
        ...
        <p className="text-gray-600">Blends with your space.</p>
      </div>
    </div>
  );
}
